...
public class Threaded_Fast_Median {
	int c = 0;
	int ss = 0;
        public static Map<String, Float> f_median = new HashMap<String, Float>();
	...
	public static void main(String args[]) throws IOException, InterruptedException {
                ...
                //String directoryWindows ="C:\\Users\\Sharmo\\Documents\\NetBeansProjects\\HW-01\\all";
        ...
        public static float kthSmallest (ArrayList a, int left, int right ,int k){
    ...
    public static int partition(ArrayList<Float>  arr, int p , int r){
